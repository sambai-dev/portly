...
- 26 tests covering update transitions, pool replacement semantics, log generations, health classification, config parsing/clamping, and rendered-frame assertions.
